<%@ Page Title="Edit Login" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master"  CodeFile="EditLogin.aspx.cs" Inherits="Account_EditLogin" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:Login runat="server" ViewStateMode="Disabled" RenderOuterTable="false" ID="EditLoginForm">
        <LayoutTemplate>
            <p class="validation-summary-errors">
                <asp:Literal runat="server" ID="FailureText" />
            </p>
            <fieldset>
                <legend>Edit Login Form</legend>
                <ol>
                    <li>
